...
// Aeon is a threshold in time that we're measuring across. This program wakes
// up and posts the message of one after it crosses the target time.
type Aeon struct {
	// Message is the content to tweet for this aeon.
	Message string

	// Target is the target time for the aeon to be posted. This is measured
